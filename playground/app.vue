<template>
  <div>
    ...
    <button @click="updateState">Update global state</button>
    <h2>Icons</h2>
    <!-- Using an icon name -->
...
const { myGlobalState, setMyGlobalState } = useMaterialYu();

const updateState = () => {
  setMyGlobalState('new value ' + Math.random().toString(36).substring(7));
};
</script>
